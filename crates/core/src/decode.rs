...
pub fn interrupt(interrupt: u8) ->  (u8, &'static [&'static [Op]]) {
    match interrupt {
        i if (i & 0x1) != 0 => (0, &[&[inc::pc], &[], &[dec::sp, read::pc, mem::split, mem::write_sp], &[write::mem, dec::sp, mem::write_sp], &[write::mem, read::INT_VBLANK, write::pc]]),
        i if (i & 0x2) != 0 => (1, &[&[inc::pc], &[], &[dec::sp, read::pc, mem::split, mem::write_sp], &[write::mem, dec::sp, mem::write_sp], &[write::mem, read::INT_STAT, write::pc]]),
        i if (i & 0x4) != 0 => (2,&[&[inc::pc], &[], &[dec::sp, read::pc, mem::split, mem::write_sp], &[write::mem, dec::sp, mem::write_sp], &[write::mem, read::INT_TIMER, write::pc]]),
        i if (i & 0x8) != 0 => (3, &[&[inc::pc], &[], &[dec::sp, read::pc, mem::split, mem::write_sp], &[write::mem, dec::sp, mem::write_sp], &[write::mem, read::INT_SERIAL, write::pc]]),
        i if (i & 0x10) != 0 => (4, &[&[inc::pc], &[], &[dec::sp, read::pc, mem::split, mem::write_sp], &[write::mem, dec::sp, mem::write_sp], &[write::mem, read::INT_JOY, write::pc]]),
        _ => unreachable!()
    }
}
...
pub fn decode(opcode: Opcode) -> &'static [&'static [Op]] {
    match opcode {
        ...
        Opcode::Rlca         => &[&[inc::pc, bits::rlc::<{ regs::A }>]],
        ...
        Opcode::Rrca         => &[&[inc::pc, bits::rrc::<{ regs::A }>]],
        ...
        Opcode::Rla          => &[&[inc::pc, bits::rl::<{ regs::A }>]],
        ...
        Opcode::Rra          => &[&[inc::pc, bits::rr::<{ regs::A }>]],
...
fn decode_cb(opcode: CBOpcode) -> &'static [&'static [Op]] {
    match opcode {
        CBOpcode::RlcB        => &[&[inc::pc, bits::rlc::<{ regs::B }>]],
        CBOpcode::RlcC        => &[&[inc::pc, bits::rlc::<{ regs::C }>]],
        CBOpcode::RlcD        => &[&[inc::pc, bits::rlc::<{ regs::D }>]],
        CBOpcode::RlcE        => &[&[inc::pc, bits::rlc::<{ regs::E }>]],
        CBOpcode::RlcH        => &[&[inc::pc, bits::rlc::<{ regs::H }>]],
        CBOpcode::RlcL        => &[&[inc::pc, bits::rlc::<{ regs::L }>]],
        CBOpcode::RlcIndHL    => &[&[inc::pc, read::hl, mem::req_read], &[read::mem, bits::rlc::<{ regs::ST }>, read::hl, mem::req_write], &[write::mem]],
        CBOpcode::RlcA        => &[&[inc::pc, bits::rlc::<{ regs::A }>]],
        CBOpcode::RrcB        => &[&[inc::pc, bits::rrc::<{ regs::B }>]],
        CBOpcode::RrcC        => &[&[inc::pc, bits::rrc::<{ regs::C }>]],
        CBOpcode::RrcD        => &[&[inc::pc, bits::rrc::<{ regs::D }>]],
        CBOpcode::RrcE        => &[&[inc::pc, bits::rrc::<{ regs::E }>]],
        CBOpcode::RrcH        => &[&[inc::pc, bits::rrc::<{ regs::H }>]],
        CBOpcode::RrcL        => &[&[inc::pc, bits::rrc::<{ regs::L }>]],
        CBOpcode::RrcIndHL    => &[&[inc::pc, read::hl, mem::req_read], &[read::mem, bits::rrc::<{ regs::ST }>, read::hl, mem::req_write], &[write::mem]],
        CBOpcode::RrcA        => &[&[inc::pc, bits::rrc::<{ regs::A }>]],
        CBOpcode::RlB         => &[&[inc::pc, bits::rl::<{ regs::B }>]],
        CBOpcode::RlC         => &[&[inc::pc, bits::rl::<{ regs::C }>]],
        CBOpcode::RlD         => &[&[inc::pc, bits::rl::<{ regs::D }>]],
        CBOpcode::RlE         => &[&[inc::pc, bits::rl::<{ regs::E }>]],
        CBOpcode::RlH         => &[&[inc::pc, bits::rl::<{ regs::H }>]],
        CBOpcode::RlL         => &[&[inc::pc, bits::rl::<{ regs::L }>]],
        CBOpcode::RlIndHL     => &[&[inc::pc, read::hl, mem::req_read], &[read::mem, bits::rl::<{ regs::ST }>, read::hl, mem::req_write], &[write::mem]],
        CBOpcode::RlA         => &[&[inc::pc, bits::rl::<{ regs::A }>]],
        CBOpcode::RrB         => &[&[inc::pc, bits::rr::<{ regs::B }>]],
        CBOpcode::RrC         => &[&[inc::pc, bits::rr::<{ regs::C }>]],
        CBOpcode::RrD         => &[&[inc::pc, bits::rr::<{ regs::D }>]],
        CBOpcode::RrE         => &[&[inc::pc, bits::rr::<{ regs::E }>]],
        CBOpcode::RrH         => &[&[inc::pc, bits::rr::<{ regs::H }>]],
        CBOpcode::RrL         => &[&[inc::pc, bits::rr::<{ regs::L }>]],
        CBOpcode::RrIndHL     => &[&[inc::pc, read::hl, mem::req_read], &[read::mem, bits::rr::<{ regs::ST }>, read::hl, mem::req_write], &[write::mem]],
        CBOpcode::RrA         => &[&[inc::pc, bits::rr::<{ regs::A }>]],
        ...
        CBOpcode::Bit0IndHL   => &[&[inc::pc, read::hl, mem::req_read], &[read::mem, bits::bit::<0, { regs::ST }>, read::hl, mem::req_write], &[write::mem]],
        ...
        CBOpcode::Bit1IndHL   => &[&[inc::pc, read::hl, mem::req_read], &[read::mem, bits::bit::<1, { regs::ST }>, read::hl, mem::req_write], &[write::mem]],
        ...
        CBOpcode::Bit2IndHL   => &[&[inc::pc, read::hl, mem::req_read], &[read::mem, bits::bit::<2, { regs::ST }>, read::hl, mem::req_write], &[write::mem]],
        ...
        CBOpcode::Bit3IndHL   => &[&[inc::pc, read::hl, mem::req_read], &[read::mem, bits::bit::<3, { regs::ST }>, read::hl, mem::req_write], &[write::mem]],
        ...
        CBOpcode::Bit4IndHL   => &[&[inc::pc, read::hl, mem::req_read], &[read::mem, bits::bit::<4, { regs::ST }>, read::hl, mem::req_write], &[write::mem]],
        ...
        CBOpcode::Bit5IndHL   => &[&[inc::pc, read::hl, mem::req_read], &[read::mem, bits::bit::<5, { regs::ST }>, read::hl, mem::req_write], &[write::mem]],
        ...
        CBOpcode::Bit6IndHL   => &[&[inc::pc, read::hl, mem::req_read], &[read::mem, bits::bit::<6, { regs::ST }>, read::hl, mem::req_write], &[write::mem]],
        ...
        CBOpcode::Bit7IndHL   => &[&[inc::pc, read::hl, mem::req_read], &[read::mem, bits::bit::<7, { regs::ST }>, read::hl, mem::req_write], &[write::mem]],
