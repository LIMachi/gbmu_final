...
pub fn rr<const R: u8, const SH: bool>(state: &mut State) -> Flow {
...
pub fn rrc<const R: u8, const SH: bool>(state: &mut State) -> Flow {
    let v = state.register(R).u8();
    let f = state.flags();
    let l = v & 0x1;
    let v = v >> 1 | l << 7;
...
pub fn rl<const R: u8, const SH: bool>(state: &mut State) -> Flow {
    let v = state.register(R).u8();
    let f = state.flags();
    let h = v >> 7;
...
pub fn rlc<const R: u8, const SH: bool>(state: &mut State) -> Flow {
    let v = state.register(R).u8();
    let f = state.flags();
    let h = v >> 7;
    let v = v << 1 | h;
